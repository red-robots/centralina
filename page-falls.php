<?php 
/**
* Template Name: Metrolina Falls Prevention
*/
 ?>
...
<div class="page-content-falls" style="padding-top: 7px!important;">


<div id="falls-home-image"><?php
...
<div id="falls-home-text"><div id="falls-home-text-padding"><?php the_content(); ?>

<div id="falls-learn-more"><a href="#">Learn More</a></div>	
</div></div>



<div id="home-row3">
<div id="home-row3-content" class="falls-home-row3-content">

<div id="upcoming-events-wrapper" class="falls-events">
...
<div id="latest-news-feed" class="falls-about">
<?php the_field("about"); ?>
</div>
